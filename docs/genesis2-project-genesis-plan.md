...
| ~~240~~ | ~~.40~~ | ~~forgejo~~ | RETIRED — LXC | Moved to helios as native Debian service | — |
...
| Forgejo placement | helios (native), not genesis2 LXC | genesis2 has planned maintenance windows. Internal Git must be reachable during those windows. i3-2120 handles Go binary without issue. VMID 240 retired. |
