...
- **Hardware Specs:** Anything in `device_specs_list.md` that conflicts with `genesis2-project-genesis-plan.md`, `helios-plan.md`, or `project-summary-and-remaining-steps.md` must be flagged.
